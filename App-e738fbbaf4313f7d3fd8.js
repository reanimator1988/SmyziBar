...
;// CONCATENATED MODULE: ./src/Redux/Redux.jsx
...
function Redux_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? Redux_ownKeys(Object(t), !0).forEach(function (r) { Redux_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : Redux_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function Redux_defineProperty(obj, key, value) { key = Redux_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function Redux_toPropertyKey(arg) { var key = Redux_toPrimitive(arg, "string"); return Redux_typeof(key) === "symbol" ? key : String(key); }
function Redux_toPrimitive(input, hint) { if (Redux_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (Redux_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }

var loadOrdersFromLocalStorage = function loadOrdersFromLocalStorage() {
  try {
...
var loadTotalAmountFromLocalStorage = function loadTotalAmountFromLocalStorage() {
  try {
    var serializedTotalAmount = localStorage.getItem('totalAmount');
  ...
  reducers: {
    addOrder: function addOrder(state, action) {
      var _action$payload = action.payload,
        cocktailName = _action$payload.cocktailName,
        price = _action$payload.price,
        volume = _action$payload.volume;
      var order = {
    ...
    removeOrder: function removeOrder(state, action) {
      var indexToRemove = action.payload;
      var removedOrder = state.orders[indexToRemove];
...
var _cartSlice$actions = cartSlice.actions,
  addOrder = _cartSlice$actions.addOrder,
  removeOrder = _cartSlice$actions.removeOrder;

/* harmony default export */ const Redux = (cartSlice.reducer);
;// CONCATENATED MODULE: ./src/Redux/ReduxMenuConstr.jsx
function ReduxMenuConstr_typeof(o) { "@babel/helpers - typeof"; return ReduxMenuConstr_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, ReduxMenuConstr_typeof(o); }
function ReduxMenuConstr_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function ReduxMenuConstr_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ReduxMenuConstr_ownKeys(Object(t), !0).forEach(function (r) { ReduxMenuConstr_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ReduxMenuConstr_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function ReduxMenuConstr_defineProperty(obj, key, value) { key = ReduxMenuConstr_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function ReduxMenuConstr_toPropertyKey(arg) { var key = ReduxMenuConstr_toPrimitive(arg, "string"); return ReduxMenuConstr_typeof(key) === "symbol" ? key : String(key); }
function ReduxMenuConstr_toPrimitive(input, hint) { if (ReduxMenuConstr_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (ReduxMenuConstr_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }

var saveDataToLocalStorage = function saveDataToLocalStorage(dataKey, data) {
  try {
    localStorage.setItem(dataKey, JSON.stringify(data));
  } catch (error) {
    console.error("Error saving ".concat(dataKey, " to localStorage:"), error);
  }
};
var ReduxMenuConstr_loadOrdersFromLocalStorage = function loadOrdersFromLocalStorage() {
  try {
    var serializedOrders = localStorage.getItem('menuOrders');
    if (serializedOrders === null) {
      return [];
    }
    var orders = JSON.parse(serializedOrders);
    var updatedOrders = orders.map(function (order) {
      return ReduxMenuConstr_objectSpread(ReduxMenuConstr_objectSpread({}, order), {}, {
        price: isNaN(order.price) ? 0 : parseFloat(order.price),
        cocktailName: order.cocktailName || ''
      });
    });
...
var ReduxMenuConstr_loadTotalAmountFromLocalStorage = function loadTotalAmountFromLocalStorage() {
  try {
    var serializedTotalAmount = localStorage.getItem('menuTotalAmount');
    if (serializedTotalAmount === null) {
      return 0;
    }
    return parseFloat(serializedTotalAmount);
...
var initialState = {
  selectedItems: ReduxMenuConstr_loadOrdersFromLocalStorage(),
  totalVolume: ReduxMenuConstr_loadTotalAmountFromLocalStorage(),
  totalCost: 0
};
  ...
  reducers: {
    ...
    removeItem: function removeItem(state, action) {
      state.selectedItems = state.selectedItems.filter(function (item) {
        return item.cocktailName !== action.payload.cocktailName;
      });
      saveDataToLocalStorage('menuOrders', state.selectedItems);
    },
    setVolume: function setVolume(state, action) {
...
var _menuSlice$actions = menuSlice.actions,
  addItem = _menuSlice$actions.addItem,
  removeItem = _menuSlice$actions.removeItem,
  setVolume = _menuSlice$actions.setVolume,
  ReduxMenuConstr_reset = _menuSlice$actions.reset;

/* harmony default export */ const ReduxMenuConstr = (menuSlice.reducer);
;// CONCATENATED MODULE: ./src/Redux/store.jsx
...
function useDataRouterContext(hookName) {
  ...
  !ctx ?  false ? 0 : router_invariant(false) : void 0;
  return ctx;
}
...
;// CONCATENATED MODULE: ./static/korzina-1.png
const korzina_1_namespaceObject = __webpack_require__.p + "images/korzina-1-61f75e2e3459fe56b71f.png";
...
var Header = function Header() {
  var cartOrders = useSelector(function (state) {
    return state.cart.orders;
  });
  var cartItemsCount = cartOrders.length;
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("nav", null, /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement(Link, {
    ...
    to: "/menu-constructor"
  }, "\u0421\u041C\u0423\u0417\u0406-\u041A\u041E\u041D\u0421\u0422\u0420\u0423\u041A\u0422\u041E\u0420")), /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement(Link, {
    to: "/materials"
  }, "\u041F\u0420\u041E \u041D\u0410\u0421")), /*#__PURE__*/react.createElement(Link, {
    to: "/cart"
  }, /*#__PURE__*/react.createElement("img", {
    src: korzina_1_namespaceObject,
    alt: "\u041A\u043E\u0440\u0437\u0438\u043D\u0430"
  }), cartItemsCount > 0 && /*#__PURE__*/react.createElement("span", {
...
/* harmony default export */ const Description = (function () {
  (0,react.useEffect)(function () {
    ...
    var link = document.querySelector(".main-btn");
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "main-descr"
  }, /*#__PURE__*/react.createElement("p", {
    className: "Description"
  }, "Alcohol for the modern drinker"), /*#__PURE__*/react.createElement("p", {
    className: "main-text"
  }, "Light and refreshing flavors made with real, clean ingredients you can feel good about. Just pour, sip, and enjoy."), /*#__PURE__*/react.createElement("a", {
    href: "#",
    className: "main-btn"
  }, "Shop ALL"));
});
...
var Main = function Main() {
  ...
  }, /*#__PURE__*/react.createElement(Description, null), /*#__PURE__*/react.createElement("div", {
    className: "left-side"
  }));
};
/* harmony default export */ const Main_Main = (Main);
{/* <LogoComponent logoSrc={logo} /> */}
;// CONCATENATED MODULE: ./static/imagesConstr/apple.jpeg
const apple_namespaceObject = __webpack_require__.p + "images/apple-f5edf6a17bae4c590eb5.jpeg";
;// CONCATENATED MODULE: ./static/imagesConstr/banan.png
const banan_namespaceObject = __webpack_require__.p + "images/banan-3fc150da16d471249c85.png";
;// CONCATENATED MODULE: ./static/imagesConstr/apelsiny.png
const apelsiny_namespaceObject = __webpack_require__.p + "images/apelsiny-60d63b0491453ca7b9e5.png";
;// CONCATENATED MODULE: ./static/imagesConstr/morkva.jpg
const morkva_namespaceObject = __webpack_require__.p + "images/morkva-5f6366cb60b40ca7f0e6.jpg";
;// CONCATENATED MODULE: ./static/imagesConstr/spinat.png
const spinat_namespaceObject = __webpack_require__.p + "images/spinat-26ebfaf842435d8458b0.png";
;// CONCATENATED MODULE: ./static/imagesConstr/maracuja-1.jpg
const maracuja_1_namespaceObject = __webpack_require__.p + "images/maracuja-1-e7e916068ea2ca091e7f.jpg";
;// CONCATENATED MODULE: ./static/imagesConstr/kiwi.webp
const kiwi_namespaceObject = __webpack_require__.p + "images/kiwi-af5f9c945c7b15f102f0.webp";
;// CONCATENATED MODULE: ./static/imagesConstr/ananas.jpg
const ananas_namespaceObject = __webpack_require__.p + "images/ananas-15e89246a226a28f3405.jpg";
;// CONCATENATED MODULE: ./static/imagesConstr/Avocado-PNG.png
const Avocado_PNG_namespaceObject = __webpack_require__.p + "images/Avocado-PNG-563d1cd9f12c2655c066.png";
;// CONCATENATED MODULE: ./static/imagesConstr/kokos.webp
const kokos_namespaceObject = __webpack_require__.p + "images/kokos-564b6856215f975ef773.webp";
;// CONCATENATED MODULE: ./static/imagesConstr/mango.webp
const mango_namespaceObject = __webpack_require__.p + "images/mango-7eaf430667301c02580b.webp";
;// CONCATENATED MODULE: ./static/imagesConstr/klubnika.png
const klubnika_namespaceObject = __webpack_require__.p + "images/klubnika-ee461af3a0b7a54b7cc9.png";
;// CONCATENATED MODULE: ./src/components/Header/MenuConstructor/MenuConstr.jsx
...
var productData = [{
  cocktailName: "Яблуко",
  image: apple_namespaceObject,
  available: true,
  price: 390
}, {
  cocktailName: "Банан",
  image: banan_namespaceObject,
  available: false,
  price: 360
}, {
  cocktailName: "Апельсин",
  image: apelsiny_namespaceObject,
  available: true,
  price: 410
}, {
  cocktailName: "Морква",
  image: morkva_namespaceObject,
  available: true,
  pricePerLiter: 510
}, {
  cocktailName: "Спанач",
  image: spinat_namespaceObject,
  available: true,
  pricePerLiter: 360
}, {
  cocktailName: "Маракуя",
  image: maracuja_1_namespaceObject,
  available: true,
  pricePerLiter: 440
}, {
  cocktailName: "Ківі",
  image: kiwi_namespaceObject,
  available: true,
  pricePerLiter: 340
}, {
  cocktailName: "Ананас",
  image: ananas_namespaceObject,
  available: true,
  pricePerLiter: 480
}, {
  cocktailName: "Авокадо",
  image: Avocado_PNG_namespaceObject,
  available: true,
  pricePerLiter: 560
}, {
  cocktailName: "Кокос",
  image: kokos_namespaceObject,
  available: false,
  pricePerLiter: 420
}, {
  cocktailName: "Манго",
  image: mango_namespaceObject,
  available: false,
  pricePerLiter: 380
}, {
  cocktailName: "Полуниця",
  image: klubnika_namespaceObject,
  available: true,
  price: 350
}];
function MenuConstr() {
  ...
  var _useState3 = (0,react.useState)(200),
    ...
    totalVolume = _useState4[0],
    setTotalVolume = _useState4[1];
  var _useState5 = (0,react.useState)(0),
    _useState6 = _slicedToArray(_useState5, 2),
    totalCost = _useState6[0],
    setTotalCost = _useState6[1];
  var _useState7 = (0,react.useState)(false),
    _useState8 = _slicedToArray(_useState7, 2),
    isImagePopupOpen = _useState8[0],
    setImagePopupOpen = _useState8[1];
  var _useState9 = (0,react.useState)(false),
    _useState10 = _slicedToArray(_useState9, 2),
    formSubmitted = _useState10[0],
    setFormSubmitted = _useState10[1];
  var _useState11 = (0,react.useState)(""),
    _useState12 = _slicedToArray(_useState11, 2),
    submitMessage = _useState12[0],
    setSubmitMessage = _useState12[1];
  var dispatch = useDispatch();
  var handleSelectItem = function handleSelectItem(item) {
    var selectedProduct = productData.find(function (product) {
      return product.cocktailName === item;
    });
    if (selectedProduct && selectedProduct.available && selectedItems.length < 5) {
      setSelectedItems(function (prevItems) {
        return [].concat(_toConsumableArray(prevItems), [selectedProduct]);
      });
    } else {
      alert("Неможливо додати, максимально 5 інгрідіентів :) ");
    }
  };
  var handleSelectVolume = function handleSelectVolume(volume) {
  ...
  var handleOrderClick = function handleOrderClick() {
    ...
    if (selectedItems.length === 0) {
      ...
      dispatch(ReduxMenuConstr_reset());
      setSelectedItems([]);
      setTotalVolume(200);
      setTotalCost(0);
    }
  ...
  (0,react.useEffect)(function () {
    ...
    var volumePerItem = totalVolume / itemsCount;
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "MenuConstr"
  }, /*#__PURE__*/react.createElement("h3", {
    className: "MenuConstr-header"
  }, "\u0421\u0442\u043E\u0440\u0456\u043D\u043A\u0430 \u0421\u043C\u0443\u0437\u0456 \u043A\u043E\u043D\u0441\u0442\u0440\u0443\u043A\u0442\u043E\u0440"), /*#__PURE__*/react.createElement("h2", null, "\u041E\u0431\u0435\u0440\u0456\u0442\u044C \u043F\u0440\u043E\u0434\u0443\u043A\u0442 \u0442\u0430 \u043E\u0431'\u0454\u043C:"), /*#__PURE__*/react.createElement("div", {
    ...
    onChange: function onChange(e) {
      return handleSelectVolume(e.target.value);
    }
  }, /*#__PURE__*/react.createElement("option", {
    value: 200
  }, "200 \u043C\u043B"), /*#__PURE__*/react.createElement("option", {
    value: 500
  }, "500 \u043C\u043B"), /*#__PURE__*/react.createElement("option", {
    value: 1000
  }, "1 \u043B"))))), /*#__PURE__*/react.createElement("button", {
    className: "MenuConstr-btn",
    onClick: handleOrderClick
  }, "\u0417\u0410\u041C\u041E\u0412\u0418\u0422\u0418 \u041F\u0420\u041E\u0414\u0423\u041A\u0422\u0418"), isImagePopupOpen && /*#__PURE__*/react.createElement("div", {
    className: "image-popup"
  }, /*#__PURE__*/react.createElement("button", {
    className: "close-button",
    onClick: function onClick() {
      return setImagePopupOpen(false);
    }
    ...
    return /*#__PURE__*/react.createElement("div", {
      key: index,
      className: "image-item ".concat(!product.available ? "unavailable" : ""),
      onClick: function onClick() {
        return handleSelectItem(product.cocktailName);
      }
    }, /*#__PURE__*/react.createElement("img", {
      src: product.image,
    ...
    }, product.cocktailName), /*#__PURE__*/react.createElement("p", {
      className: "product-pricePerLiter"
    }, product.price, " \u0433\u0440\u043D"));
  }))), /*#__PURE__*/react.createElement("h2", null, "\u0412\u0438\u0431\u0440\u0430\u043D\u0456 \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u0438:"), /*#__PURE__*/react.createElement("p", null, "\u041E\u0431\u0449\u0438\u0439 \u043E\u0431'\u0454\u043C: ", totalVolume, " \u043C\u043B"), /*#__PURE__*/react.createElement("ul", {
  ...
  })), /*#__PURE__*/react.createElement("p", null, "\u0417\u0430\u0433\u0430\u043B\u044C\u043D\u0430 \u0432\u0430\u0440\u0442\u0456\u0441\u0442\u044C: ", totalCost, " \u0433\u0440\u043D"), /*#__PURE__*/react.createElement("button", {
    className: "MenuConstr-btn",
    onClick: handleOrderClick
  }, "\u0414\u043E \u043A\u043E\u0440\u0437\u0438\u043D\u0438"), formSubmitted && /*#__PURE__*/react.createElement("p", {
    className: "form-submitted-message"
  }, submitMessage));
}
/* harmony default export */ const MenuConstructor_MenuConstr = (MenuConstr);
;// CONCATENATED MODULE: ./src/components/Header/materialsComponent/materials.jsx
...
var Materials = function Materials() {
  ...
  }, /*#__PURE__*/react.createElement("h2", null, "\u041B\u0430\u0441\u043A\u0430\u0432\u043E \u043F\u0440\u043E\u0441\u0438\u043C\u043E \u0434\u043E \u043D\u0430\u0448\u043E\u0433\u043E \u0431\u0430\u0440\u0443 \"\u0421\u043C\u0430\u043A\u043E\u0414\u0435\u043B\u0456\u043A\u0430\u0442\u0435\u0441\u0438\"!"), /*#__PURE__*/react.createElement("p", null, "\uD83C\uDF79 ", /*#__PURE__*/react.createElement("span", null, "\u041F\u0440\u043E \u043D\u0430\u0441:"), /*#__PURE__*/react.createElement("br", null), "\"\u0421\u043C\u0430\u043A\u043E\u0414\u0435\u043B\u0456\u043A\u0430\u0442\u0435\u0441\u0438\" - \u0446\u0435 \u0443\u043D\u0456\u043A\u0430\u043B\u044C\u043D\u0435 \u043C\u0456\u0441\u0446\u0435, \u0434\u0435 \u0441\u043C\u0430\u043A \u0456 \u0437\u0434\u043E\u0440\u043E\u0432'\u044F \u043F\u043E\u0454\u0434\u043D\u0443\u044E\u0442\u044C\u0441\u044F \u0432 \u043E\u0434\u043D\u043E\u043C\u0443 \u043A\u0435\u043B\u0438\u0445\u0443. \u041D\u0430\u0448 \u0431\u0430\u0440 \u0441\u043F\u0435\u0446\u0456\u0430\u043B\u0456\u0437\u0443\u0454\u0442\u044C\u0441\u044F \u043D\u0430 \u043F\u0440\u0438\u0433\u043E\u0442\u0443\u0432\u0430\u043D\u043D\u0456 \u043D\u0430\u0439\u0441\u043C\u0430\u0447\u043D\u0456\u0448\u0438\u0445 \u0441\u043C\u0443\u0437\u0456 \u0442\u0430 \u043A\u043E\u043A\u0442\u0435\u0439\u043B\u0456\u0432, \u044F\u043A\u0456 \u0437\u0430\u0432\u0436\u0434\u0438 \u0440\u0430\u0434\u0443\u044E\u0442\u044C \u0432\u0430\u0448\u0456 \u0441\u043C\u0430\u043A\u043E\u0432\u0456 \u0440\u0435\u0446\u0435\u043F\u0442\u043E\u0440\u0438 \u0456 \u0437\u0430\u0440\u044F\u0434\u0436\u0430\u044E\u0442\u044C \u0435\u043D\u0435\u0440\u0433\u0456\u0454\u044E."), /*#__PURE__*/react.createElement("p", null, "\uD83C\uDF4F", /*#__PURE__*/react.createElement("span", null, " \u0421\u043C\u0443\u0437\u0456:"), /*#__PURE__*/react.createElement("br", null), "\u041D\u0430 \"\u0421\u043C\u0430\u043A\u043E\u0414\u0435\u043B\u0456\u043A\u0430\u0442\u0435\u0441\u0438\" \u043C\u0438 \u0432\u0456\u0440\u0438\u043C\u043E \u0443 \u0441\u0438\u043B\u0443 \u043F\u0440\u0438\u0440\u043E\u0434\u043D\u0438\u0445 \u0456\u043D\u0433\u0440\u0435\u0434\u0456\u0454\u043D\u0442\u0456\u0432. \u041D\u0430\u0448\u0456 \u0441\u043C\u0443\u0437\u0456 \u043F\u0440\u0438\u0433\u043E\u0442\u043E\u0432\u043B\u044E\u044E\u0442\u044C\u0441\u044F \u0437\u0456 \u0441\u0432\u0456\u0436\u0438\u0445 \u0444\u0440\u0443\u043A\u0442\u0456\u0432 \u0456 \u043E\u0432\u043E\u0447\u0456\u0432, \u0431\u0435\u0437 \u0446\u0443\u043A\u0440\u0443 \u0442\u0430 \u043A\u043E\u043D\u0441\u0435\u0440\u0432\u0430\u043D\u0442\u0456\u0432. \u0421\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043D\u0430\u0448 \"\u0417\u0435\u043B\u0435\u043D\u0438\u0439 \u041E\u0430\u0437\u0438\u0441\" - \u0441\u043C\u0443\u0437\u0456 \u0437 \u0448\u043F\u0438\u043D\u0430\u0442\u0443, \u0430\u043D\u0430\u043D\u0430\u0441\u0430 \u0442\u0430 \u0431\u0430\u043D\u0430\u043D\u0430, \u044F\u043A\u0438\u0439 \u0437\u0430\u0431\u0435\u0437\u043F\u0435\u0447\u0438\u0442\u044C \u0432\u0430\u043C \u0432\u0438\u0442\u043E\u043A\u0438 \u0432\u0456\u0442\u0430\u043C\u0456\u043D\u0456\u0432 \u0442\u0430 \u0437\u0430\u0440\u044F\u0434 \u0434\u043E\u0431\u0440\u043E\u0433\u043E \u043D\u0430\u0441\u0442\u0440\u043E\u044E."), /*#__PURE__*/react.createElement("p", null, "\uD83C\uDF78 ", /*#__PURE__*/react.createElement("span", null, "\u041A\u043E\u043A\u0442\u0435\u0439\u043B\u0456:"), /*#__PURE__*/react.createElement("br", null), "\u041D\u0430\u0448\u0456 \u0431\u0430\u0440\u043C\u0435\u043D\u0456 - \u0441\u043F\u0440\u0430\u0432\u0436\u043D\u0456 \u043C\u0430\u0439\u0441\u0442\u0440\u0438 \u0443 \u0441\u0442\u0432\u043E\u0440\u0435\u043D\u043D\u0456 \u043A\u043E\u043A\u0442\u0435\u0439\u043B\u0456\u0432. \u041C\u0438 \u043F\u0440\u043E\u043F\u043E\u043D\u0443\u0454\u043C\u043E \u0448\u0438\u0440\u043E\u043A\u0438\u0439 \u0432\u0438\u0431\u0456\u0440 \u043A\u043B\u0430\u0441\u0438\u0447\u043D\u0438\u0445 \u0456 \u0430\u0432\u0442\u043E\u0440\u0441\u044C\u043A\u0438\u0445 \u043A\u043E\u043A\u0442\u0435\u0439\u043B\u0456\u0432, \u044F\u043A\u0456 \u0433\u0430\u0440\u043C\u043E\u043D\u0456\u0439\u043D\u043E \u043F\u043E\u0454\u0434\u043D\u0443\u044E\u0442\u044C \u0432 \u0441\u043E\u0431\u0456 \u0440\u0456\u0437\u043D\u0456 \u0441\u043C\u0430\u043A\u0438 \u0456 \u0430\u0440\u043E\u043C\u0430\u0442\u0438. \u0421\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043D\u0430\u0448 \"\u041B\u0430\u0432\u0430\u043D\u0434\u043E\u0432\u0438\u0439 \u0414\u0436\u0438\u043D \u0422\u043E\u043D\u0456\u043A\", \u044F\u043A\u0438\u0439 \u043E\u0431'\u0454\u0434\u043D\u0443\u0454 \u0441\u0432\u0456\u0436\u0438\u0439 \u043B\u0438\u043C\u043E\u043D, \u0430\u0440\u043E\u043C\u0430\u0442\u043D\u0443 \u043B\u0430\u0432\u0430\u043D\u0434\u0443 \u0442\u0430 \u043D\u0430\u0439\u043A\u0440\u0430\u0449\u0438\u0439 \u0434\u0436\u0438\u043D."), /*#__PURE__*/react.createElement("p", null, "\uD83D\uDCDE ", /*#__PURE__*/react.createElement("span", null, "\u041A\u043E\u043D\u0442\u0430\u043A\u0442\u0438:"), /*#__PURE__*/react.createElement("br", null), "\u041C\u0438 \u0437\u0430\u0432\u0436\u0434\u0438 \u0440\u0430\u0434\u0456 \u0431\u0430\u0447\u0438\u0442\u0438 \u0432\u0430\u0441 \u0443 \"\u0421\u043C\u0430\u043A\u043E\u0414\u0435\u043B\u0456\u043A\u0430\u0442\u0435\u0441\u0438\"! \u0417\u0432\u0435\u0440\u0442\u0430\u0439\u0442\u0435\u0441\u044F \u0434\u043E \u043D\u0430\u0441 \u0437\u0430 \u0430\u0434\u0440\u0435\u0441\u043E\u044E \u0432\u0443\u043B. \u0413\u0430\u0441\u0442\u0440\u043E\u043D\u043E\u043C\u0456\u0447\u043D\u0430, 42, \u0430\u0431\u043E \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0443\u0439\u0442\u0435 \u043D\u0430\u043C \u0437\u0430 \u043D\u043E\u043C\u0435\u0440\u043E\u043C (123) 456-7890. \u0414\u043B\u044F \u0437\u0430\u043C\u043E\u0432\u043B\u0435\u043D\u043D\u044F \u0441\u0442\u043E\u043B\u0438\u043A\u0456\u0432 \u0430\u0431\u043E \u0456\u043D\u0448\u0438\u0445 \u043F\u0438\u0442\u0430\u043D\u044C, \u0432\u0438 \u043C\u043E\u0436\u0435\u0442\u0435 \u0442\u0430\u043A\u043E\u0436 \u043D\u0430\u043F\u0438\u0441\u0430\u0442\u0438 \u043D\u0430\u043C \u043D\u0430 \u0435\u043B\u0435\u043A\u0442\u0440\u043E\u043D\u043D\u0443 \u043F\u043E\u0448\u0442\u0443: francev.dima@gmail.com"), /*#__PURE__*/react.createElement("p", null, "\u041D\u0435\u0445\u0430\u0439 \u0432\u0430\u0448\u0435 \u0432\u0456\u0434\u0432\u0456\u0434\u0443\u0432\u0430\u043D\u043D\u044F \"\u0421\u043C\u0430\u043A\u043E\u0414\u0435\u043B\u0456\u043A\u0430\u0442\u0435\u0441\u0438\" \u0431\u0443\u0434\u0435 \u0441\u043C\u0430\u0447\u043D\u0438\u043C \u0456 \u043D\u0435\u0437\u0430\u0431\u0443\u0442\u043D\u0456\u043C \u0434\u043E\u0441\u0432\u0456\u0434\u043E\u043C! \u0411\u0435\u0437\u043A\u043E\u0448\u0442\u043E\u0432\u043D\u0430 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430 \u0441\u043C\u0443\u0437\u0456 \u0442\u0430 \u043A\u043E\u043A\u0442\u0435\u0439\u043B\u0456\u0432 \u0434\u043E \u0432\u0430\u0448\u043E\u0433\u043E \u0434\u043E\u043C\u0443 \u0442\u0430\u043A\u043E\u0436 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430, \u0449\u043E\u0431 \u0432\u0438 \u043C\u043E\u0433\u043B\u0438 \u043D\u0430\u0441\u043E\u043B\u043E\u0434\u0436\u0443\u0432\u0430\u0442\u0438\u0441\u044F \u043D\u0430\u0448\u0438\u043C\u0438 \u043D\u0430\u043F\u043E\u044F\u043C\u0438 \u0432 \u0431\u0443\u0434\u044C-\u044F\u043A\u0438\u0439 \u0447\u0430\u0441. \u0414\u043E \u0437\u0443\u0441\u0442\u0440\u0456\u0447\u0456 \u0432 \"\u0421\u043C\u0430\u043A\u043E\u0414\u0435\u043B\u0456\u043A\u0430\u0442\u0435\u0441\u0438\"! \uD83E\uDD42\uD83C\uDF79")));
};
...
;// CONCATENATED MODULE: ./src/components/Header/Shopingcart/ShopingCart.jsx
function ShopingCart_typeof(o) { "@babel/helpers - typeof"; return ShopingCart_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, ShopingCart_typeof(o); }
function ShopingCart_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function ShopingCart_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ShopingCart_ownKeys(Object(t), !0).forEach(function (r) { ShopingCart_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ShopingCart_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function ShopingCart_defineProperty(obj, key, value) { key = ShopingCart_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function ShopingCart_toPropertyKey(arg) { var key = ShopingCart_toPrimitive(arg, "string"); return ShopingCart_typeof(key) === "symbol" ? key : String(key); }
function ShopingCart_toPrimitive(input, hint) { if (ShopingCart_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (ShopingCart_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function ShopingCart_slicedToArray(arr, i) { return ShopingCart_arrayWithHoles(arr) || ShopingCart_iterableToArrayLimit(arr, i) || ShopingCart_unsupportedIterableToArray(arr, i) || ShopingCart_nonIterableRest(); }
function ShopingCart_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function ShopingCart_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ShopingCart_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ShopingCart_arrayLikeToArray(o, minLen); }
function ShopingCart_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function ShopingCart_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function ShopingCart_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var ShoppingCart = function ShoppingCart() {
  ...
  var menuItems = useSelector(function (state) {
    return state.menu.selectedItems;
  });
  var dispatch = useDispatch();
  var _useState = (0,react.useState)(false),
    _useState2 = ShopingCart_slicedToArray(_useState, 2),
    showConfirmation = _useState2[0],
    setShowConfirmation = _useState2[1];
  var _useState3 = (0,react.useState)(null),
    _useState4 = ShopingCart_slicedToArray(_useState3, 2),
    selectedOrderIndex = _useState4[0],
    setSelectedOrderIndex = _useState4[1];
  var _useState5 = (0,react.useState)(false),
    _useState6 = ShopingCart_slicedToArray(_useState5, 2),
    isFormOpen = _useState6[0],
    setFormOpen = _useState6[1];
  var _useState7 = (0,react.useState)(null),
    _useState8 = ShopingCart_slicedToArray(_useState7, 2),
  ...
  var handleConfirmationClose = function handleConfirmationClose() {
    setShowConfirmation(false);
    setSelectedOrderIndex(null);
  };
  var handleConfirmationOK = function handleConfirmationOK() {
  ...
  var calculateTotalPrice = function calculateTotalPrice() {
    var totalPrice = cartOrders.reduce(function (total, order) {
  ...
  var resetOrderData = function resetOrderData() {
    setOrderData(null);
  };
  return /*#__PURE__*/react.createElement("div", {
    className: "shopping-cart"
  }, /*#__PURE__*/react.createElement("h4", null, "\u041A\u043E\u0448\u0438\u043A \u0437\u0430\u043C\u043E\u0432\u043B\u0435\u043D\u044C"), cartOrders.length === 0 ? /*#__PURE__*/react.createElement("div", {
    className: "empty-cart"
  }, /*#__PURE__*/react.createElement("p", {
    className: "shopping-text"
  }, "\u0429\u0435 \u043D\u0456\u0447\u043E\u0433\u043E \u043D\u0435 \u0434\u043E\u0434\u0430\u043D\u043E"), /*#__PURE__*/react.createElement(Link, {
    to: "/menu-constructor"
  }, /*#__PURE__*/react.createElement("button", {
    className: "shopping-btn"
  }, "\u0425\u043E\u0447\u0443 \u0441\u043C\u0443\u0437\u0456!"))) : /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("ul", null, cartOrders.map(function (order, index) {
    return /*#__PURE__*/react.createElement("li", {
      key: index,
      className: "shopping-li"
    }, /*#__PURE__*/react.createElement("span", {
      className: "order-number"
    }, index + 1, ". "), "\u041D\u0430\u0437\u0432\u0430 \u043A\u043E\u043A\u0442\u0435\u0439\u043B\u044F: ", order.cocktailName, ",", /*#__PURE__*/react.createElement("br", null), "\u0426\u0456\u043D\u0430: ", order.price, " \u0433\u0440\u043D.,", /*#__PURE__*/react.createElement("br", null), "\u041E\u0431'\u0454\u043C: ", order.volume, " \u043C\u043B. ,", /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("button", {
      onClick: function onClick() {
  ...
  }, "\u0417\u0430\u0433\u0430\u043B\u044C\u043D\u0430 \u0446\u0456\u043D\u0430: ", calculateTotalPrice(), " \u0433\u0440\u043D", /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("button", {
    onClick: toggleForm
  }, "\u0417\u0430\u043C\u043E\u0432\u0438\u0442\u0438"))), showConfirmation && /*#__PURE__*/react.createElement("div", {
    className: "confirmation-modal"
  }, /*#__PURE__*/react.createElement("div", {
    className: "confirmation-content"
  }, "\u0412\u0438 \u0432\u043F\u0435\u0432\u043D\u0435\u043D\u0456, \u0449\u043E \u0445\u043E\u0447\u0435\u0442\u0435 \u0432\u0438\u0434\u0430\u043B\u0438\u0442\u0438 \u0446\u0435\u0439 \u0437\u0430\u043A\u0430\u0437?", /*#__PURE__*/react.createElement("button", {
    onClick: handleConfirmationOK
  }, "OK"), /*#__PURE__*/react.createElement("button", {
    onClick: handleConfirmationClose
  }, "\u0421\u043A\u0430\u0441\u0443\u0432\u0430\u0442\u0438"))), isFormOpen ? /*#__PURE__*/react.createElement(OrderForm, {
    onSubmit: handleFormSubmit
  }) : orderData && /*#__PURE__*/react.createElement(OrderSummary, {
    data: orderData,
    deliveryOption: orderData.deliveryOption,
    onClose: resetOrderData
  })));
};
var OrderForm = function OrderForm(_ref) {
  var onSubmit = _ref.onSubmit;
  var _useState9 = (0,react.useState)('pickup'),
    _useState10 = ShopingCart_slicedToArray(_useState9, 2),
    deliveryOption = _useState10[0],
    setDeliveryOption = _useState10[1];
  var _useState11 = (0,react.useState)({
      name: '',
      phone: '',
      city: '',
    ...
    _useState12 = ShopingCart_slicedToArray(_useState11, 2),
    formData = _useState12[0],
    setFormData = _useState12[1];
  var handleChangeDeliveryOption = function handleChangeDeliveryOption(e) {
  ...
  var handleInputChange = function handleInputChange(e) {
    ...
    setFormData(ShopingCart_objectSpread(ShopingCart_objectSpread({}, formData), {}, ShopingCart_defineProperty({}, name, value)));
  };
  var handleSubmit = function handleSubmit(e) {
    e.preventDefault();
    onSubmit(ShopingCart_objectSpread(ShopingCart_objectSpread({}, formData), {}, {
      deliveryOption: deliveryOption
    }));
  };
  return /*#__PURE__*/react.createElement("div", {
    className: "order-form"
  }, /*#__PURE__*/react.createElement("h4", null, "\u0424\u043E\u0440\u043C\u0430 \u0437\u0430\u043C\u043E\u0432\u043B\u0435\u043D\u043D\u044F"), /*#__PURE__*/react.createElement("form", {
    onSubmit: handleSubmit
  }, /*#__PURE__*/react.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/react.createElement("label", null, "\u0406\u043C'\u044F"), /*#__PURE__*/react.createElement("input", {
    type: "text",
    name: "name",
    required: true,
    value: formData.name,
    ...
    className: "form-group"
  }, /*#__PURE__*/react.createElement("label", null, "\u0421\u0430\u043C\u043E\u0432\u0438\u0432\u0456\u0437 \u0430\u0431\u043E \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430"), /*#__PURE__*/react.createElement("select", {
    name: "deliveryOption",
    onChange: handleChangeDeliveryOption,
    value: deliveryOption
  }, /*#__PURE__*/react.createElement("option", {
    value: "pickup"
  }, "\u0421\u0430\u043C\u043E\u0432\u0438\u0432\u0456\u0437"), /*#__PURE__*/react.createElement("option", {
    value: "delivery"
  }, "\u0414\u043E\u0441\u0442\u0430\u0432\u043A\u0430"))), deliveryOption === 'delivery' && /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/react.createElement("label", null, "\u0413\u043E\u0440\u043E\u0434"), /*#__PURE__*/react.createElement("input", {
    type: "text",
    name: "city",
    required: true,
    value: formData.city,
    ...
    className: "form-group"
  }, /*#__PURE__*/react.createElement("label", null, "\u0423\u043B\u0438\u0446\u0430"), /*#__PURE__*/react.createElement("input", {
    type: "text",
    name: "street",
    required: true,
    ...
    className: "form-group"
  }, /*#__PURE__*/react.createElement("label", null, "\u041D\u043E\u043C\u0435\u0440 \u0434\u043E\u043C\u0430"), /*#__PURE__*/react.createElement("input", {
    type: "text",
    name: "houseNumber",
    required: true,
...
var OrderSummary = function OrderSummary(_ref2) {
  var data = _ref2.data,
    deliveryOption = _ref2.deliveryOption,
    onClose = _ref2.onClose;
  return /*#__PURE__*/react.createElement("div", {
    className: "order-summary"
  }, /*#__PURE__*/react.createElement("h4", null, "\u0412\u0430\u0448\u0435 \u0437\u0430\u043C\u043E\u0432\u043B\u0435\u043D\u043D\u044F"), /*#__PURE__*/react.createElement("p", null, "\u0406\u043C'\u044F: ", data.name), /*#__PURE__*/react.createElement("p", null, "\u0422\u0435\u043B\u0435\u0444\u043E\u043D: ", data.phone), /*#__PURE__*/react.createElement("p", null, "\u0421\u043F\u043E\u0441\u0456\u0431 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438: ", deliveryOption === 'pickup' ? 'Самовивіз' : 'Доставка'), deliveryOption === 'delivery' && /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("p", null, "\u0413\u043E\u0440\u043E\u0434: ", data.city), /*#__PURE__*/react.createElement("p", null, "\u0423\u043B\u0438\u0446\u0430: ", data.street), /*#__PURE__*/react.createElement("p", null, "\u041D\u043E\u043C\u0435\u0440 \u0434\u043E\u043C\u0430: ", data.houseNumber)), /*#__PURE__*/react.createElement("button", {
    onClick: onClose
  }, "OK"));
};
/* harmony default export */ const ShopingCart = (ShoppingCart);
;// CONCATENATED MODULE: ./src/components/Header/Shopingcart/Cart.jsx


var Menu = function Menu() {
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(ShopingCart, null));
};
/* harmony default export */ const Cart = (Menu);
;// CONCATENATED MODULE: ./static/images/leftArrow.png
const leftArrow_namespaceObject = __webpack_require__.p + "images/leftArrow-87cfe7b27ef72349e649.png";
;// CONCATENATED MODULE: ./static/images/rightArrow.png
const rightArrow_namespaceObject = __webpack_require__.p + "images/rightArrow-13ee348a54211df479f3.png";
;// CONCATENATED MODULE: ./static/images/1.jpeg
const _1_namespaceObject = __webpack_require__.p + "images/1-36fa3eb26a4b6b626af0.jpeg";
;// CONCATENATED MODULE: ./static/images/2.jpg
const _2_namespaceObject = __webpack_require__.p + "images/2-2768b9aa176257a49405.jpg";
;// CONCATENATED MODULE: ./static/images/3.jpg
const _3_namespaceObject = __webpack_require__.p + "images/3-291c4ae921df5476f67e.jpg";
;// CONCATENATED MODULE: ./static/images/4.jpg
const _4_namespaceObject = __webpack_require__.p + "images/4-3d183eb8bc27dac9b434.jpg";
;// CONCATENATED MODULE: ./static/images/5.jpg
const _5_namespaceObject = __webpack_require__.p + "images/5-b4cdec452328acf38a6e.jpg";
...
var Slider = function Slider() {
  (0,react.useEffect)(function () {
    ...
    var images = [_1_namespaceObject, _2_namespaceObject, _3_namespaceObject, _4_namespaceObject, _5_namespaceObject];
  ...
  return /*#__PURE__*/react.createElement("section", {
  ...
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h3", null, "SLIDE SHOW"), /*#__PURE__*/react.createElement("img", {
    id: "image",
    ...
    src: leftArrow_namespaceObject,
    alt: "Previous"
  })), /*#__PURE__*/react.createElement("button", {
    id: "next-btn",
    className: "next"
  }, /*#__PURE__*/react.createElement("img", {
    src: rightArrow_namespaceObject,
    alt: "Next"
  })));
};
/* harmony default export */ const Slider_Slider = (Slider);
;// CONCATENATED MODULE: ./src/components/Slider/SliderCorusel.jsx


var SliderCorusel = function SliderCorusel() {
  return /*#__PURE__*/react.createElement("div", {
    className: "slider-container"
  }, /*#__PURE__*/react.createElement(Slider_Slider, null));
};
/* harmony default export */ const Slider_SliderCorusel = (SliderCorusel);
;// CONCATENATED MODULE: ./static/images/6.jpg
const _6_namespaceObject = __webpack_require__.p + "images/6-5af7f24f7ed1f823cb0c.jpg";
;// CONCATENATED MODULE: ./static/images/7.jpg
const _7_namespaceObject = __webpack_require__.p + "images/7-d3e576784f670f6e8c5a.jpg";
;// CONCATENATED MODULE: ./static/images/8.jpg
const _8_namespaceObject = __webpack_require__.p + "images/8-a8232c1de55c86f7a508.jpg";
;// CONCATENATED MODULE: ./static/images/9.jpg
const _9_namespaceObject = __webpack_require__.p + "images/9-1956eba5a0863724a134.jpg";
;// CONCATENATED MODULE: ./static/images/10.jpg
const _10_namespaceObject = __webpack_require__.p + "images/10-6f42e117160cada6a1e0.jpg";
;// CONCATENATED MODULE: ./static/images/11.jpg
const _11_namespaceObject = __webpack_require__.p + "images/11-1d18dde911853b8daa7e.jpg";
;// CONCATENATED MODULE: ./src/components/Menu/MenuComponents.jsx
function MenuComponents_slicedToArray(arr, i) { return MenuComponents_arrayWithHoles(arr) || MenuComponents_iterableToArrayLimit(arr, i) || MenuComponents_unsupportedIterableToArray(arr, i) || MenuComponents_nonIterableRest(); }
function MenuComponents_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MenuComponents_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MenuComponents_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MenuComponents_arrayLikeToArray(o, minLen); }
function MenuComponents_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function MenuComponents_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function MenuComponents_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var MenuComponents = function MenuComponents() {
  var menuItems = [{
    imgSrc: _6_namespaceObject,
  ...
  var _useState = (0,react.useState)(false),
    _useState2 = MenuComponents_slicedToArray(_useState, 2),
    showNotification = _useState2[0],
    setShowNotification = _useState2[1];
  var dispatch = useDispatch();
  (0,react.useEffect)(function () {
    var storedState = localStorage.getItem('showNotification');
    if (storedState === 'true') {
  ...
  var handleBuyClick = function handleBuyClick(item) {
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h4", null, "\"Smoothie Bar: Taste and Health\""), /*#__PURE__*/react.createElement("div", {
    className: "menu"
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      src: item.imgSrc,
      alt: "\u0411\u043B\u044E\u0434\u043E ".concat(index + 1)
    }), /*#__PURE__*/react.createElement("div", {
      className: "menu-name"
    }, item.cocktailName), /*#__PURE__*/react.createElement("div", {
      className: "menu-item-description"
    }, item.description), /*#__PURE__*/react.createElement("div", {
      className: "menu-item-price"
    }, "\u0426\u0435\u043D\u0430: ", item.price, " \u0433\u0440\u043D."), /*#__PURE__*/react.createElement("div", {
      className: "menu-item-old-price"
    }, "\u0421\u0442\u0430\u0440\u0430\u044F \u0446\u0435\u043D\u0430: ", item.oldPrice, " \u0433\u0440\u043D."), /*#__PURE__*/react.createElement("div", {
      className: "volume-label"
    }, "\u041E\u0431'\u0454\u043C: ", item.volume, " \u043C\u043B"), /*#__PURE__*/react.createElement("button", {
      onClick: function onClick() {
        return handleBuyClick(item);
      }
    }, "\u0432 \u041A\u043E\u0440\u0437\u0438\u043D\u0443"));
  })), /*#__PURE__*/react.createElement("div", {
    className: "notification ".concat(showNotification ? '' : 'hidden')
  }, "\u0417\u0430\u043A\u0430\u0437 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D"));
};
/* harmony default export */ const Menu_MenuComponents = (MenuComponents);
...
var Menu_Menu = function Menu() {
  ...
  }, /*#__PURE__*/react.createElement(Menu_MenuComponents, null));
};
/* harmony default export */ const components_Menu_Menu = (Menu_Menu);
...
var App = function App() {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Header_Header, null), /*#__PURE__*/react.createElement(Routes, null, /*#__PURE__*/react.createElement(Route, {
    path: "/",
    element: /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Main_Main, null), /*#__PURE__*/react.createElement(Slider_SliderCorusel, null), /*#__PURE__*/react.createElement(components_Menu_Menu, null))
  }), /*#__PURE__*/react.createElement(Route, {
    path: "/menu-constructor",
    element: /*#__PURE__*/react.createElement(MenuConstructor_MenuConstr, null)
  }), /*#__PURE__*/react.createElement(Route, {
    path: "/materials",
...
rootElement.render( /*#__PURE__*/react.createElement(components_Provider, {
  store: Redux_store
